...
const LEVELS = [
  ...
  },
  {
    ...
    type: 'single-answer',
    instructionHtml: '<p><strong>Задание:</strong> Найди на карте Дом купца П.И.Ширяева и напиши регистрационный номер дома 532511431160005.</p><p>Я думал меня тут свяжут когда я это все делал.</p>',
